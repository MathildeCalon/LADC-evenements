...
function Content() {
    return (
        <div className='flex-fill container p-20'>
            ...
            <h2 id="presentation" className="my-30 d-flex">Bienvenue chez LADC ÉVÉNEMENTS.</h2>
            ...
            <div id="contact" className={`${styles.contact} flex-fill my-30 p-20`}>
                <h2>Contactez nous !</h2>
                <ul>
                    <p>Pour toute demande de réservation ou pour toute demande de renseignement :</p>
